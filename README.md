# Bible House Editorial — Shopify theme

A Shopify Online Store 2.0 theme based on the supplied Bible Band editorial HTML. Store data stays dynamic: products, collections, menus, policies, pages, prices, variants, cart contents, search results, and customer-account links all come from Shopify.

## Install

1. Zip the contents of this folder (the theme folders must be at the ZIP root).
2. In Shopify admin, open **Online Store → Themes → Import theme → Upload zip file**.
...
- Homepage
- Product and collection catalog
- All collections
- Cart and search
- Standard page and contact page
- Blog and article
- Bible Band FAQ
